...
type FormalPdfViewerScreenProps = {
  docname: string;
  doctype: string;
  pageTitle: string;
  template?: string;
...
export function FormalPdfViewerScreen({
  docname,
  doctype,
  pageTitle,
  template = 'standard',
  ...
  }, [doctype, docname, showError, template]);
  ...
  return (
    <View style={styles.screen}>
      <MobilePageHeader onBack={onBack} showBack title={pageTitle} />
      ...
      <View style={[styles.footer, { paddingBottom: Math.max(insets.bottom, 12) }]}>
        <View style={styles.footerRow}>
          <Pressable onPress={onBack} style={[styles.footerButton, styles.footerGhostButton]}>
